...
class Settings(BaseSettings):
    ...
    # Platform credentials (not needed for theprotocol.it, kept for backward compatibility)
    platform_email: str = Field(default="", description="Job platform account email (optional)")
    platform_password: str = Field(default="", description="Job platform account password (optional)")
